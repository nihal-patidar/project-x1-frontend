...
export const DataState = (props) => {
    ...
    qrPreView: false , addValidatorForm : false , registerCompany : false , form1 : true , form2 : false , login : false , addServiceForm : false,updateServiceForm : false,registration : true})
