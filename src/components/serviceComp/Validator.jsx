...
const Validator = (props) => {
    ...
    const {
        ...
        aadhar_number, gender, position, salary, time_shift, service_id, work_time, validator_image_url
    } = props.validator;
    ...
    return (<div class=" flex w-[95%] h-56 bg-white shadow-md items-center border-2 border-orange-200 rounded-lg overflow-hidden justify-around my-2">
        <div className="flex flex-col justify-around center w-52">
            <img class="h-32 w-32 object-cover bg-slate-200" src={validator_image_url} alt="Profile Photo" />
