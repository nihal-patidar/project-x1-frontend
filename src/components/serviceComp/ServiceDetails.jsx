...
const ServiceDetails = ({ register }) => {

    let options = ["immedetly", "1 Day", "3 Days", "10 Days", "15 Days", "1 Month", "3 Months", "6 Months", "12 Months", "Other"];
    ...
    return (
        <div>
            ...
            <div className="w-full">
                <label className="inline-block mb-1 pl-1" htmlFor="dis">Discription</label>
                <textarea
