...
<<<<<<< HEAD
    <div className="flex flex-col items-center mt-6 lg:mt-20">
      ...
      "Seamless ticket management, secure authentication, automated email, WhatsApp Business integration, efficient form submissions, real-time notifications, and customer support."
      </p>
...
>>>>>>> 766b2a74da4e98fd47a495cffd3d8fcecb599d3f
      </div>
